module memory_arbitrer #(
    ...
    output logic [BITS_CACHELINE-1:0] mem_wdata_o,
    input  logic                      mem_ready_i,
    input  logic [BITS_CACHELINE-1:0] mem_rdata_i
);
    ...
    always_comb begin
        ...
        case (state)
            ...
            SERVING_D: if (mem_ready_i)   next_state = IDLE;
            SERVING_I: if (mem_ready_i)   next_state = IDLE;
    ...
    always_comb begin
        ...
        ic_frsp_data_o  = mem_rdata_i;
        dc_frsp_valid_o = 1'b0;
        dc_frsp_data_o  = mem_rdata_i;
        ...
        case (state)
            SERVING_D: begin
                ...
                mem_wdata_o     = dc_freq_data_i;
                dc_frsp_valid_o = mem_ready_i;
            end
